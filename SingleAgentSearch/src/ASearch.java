...
{	
	public List<TopSpinPuzzleMove> solve(TopSpinPuzzle problem)
	{
	...
	private	ASearchNode	abstractSearch(	TopSpinPuzzleState problemState)
	{
		initLists();
	...
	private List<TopSpinPuzzleMove> goalNodeToSolutionPath(	ASearchNode goal)
	{
		if (goal == null)
			return null;
